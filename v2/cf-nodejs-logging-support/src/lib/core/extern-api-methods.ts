...
export function createWinstonTransport() { }
export function createLogger(_object?: Object) { }
export function registerCustomFields(_object: Object) { }
export function setCustomFields(_object: Object) { }
export function setLogPattern() { }
export function overrideNetworkField(_field: string, _value: string) { }
export function overrideCustomFieldFormat(_value: string) { }
